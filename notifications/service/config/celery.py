...
app.conf.task_queues = (
	...
	Queue('notifications.pong.tournament_invitation.decline', Exchange('pong'), routing_key='pong.tournament_invitation.decline'),
...
app.conf.task_routes = {
	...
	"pong.tournament_invitation.decline": {"queue": "notifications.pong.tournament_invitation.decline"},
