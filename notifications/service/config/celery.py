...
app.conf.task_queues = (
	...
	Queue('notifications.pong.tournament_finished', Exchange('pong'), routing_key='pong.tournament_finished'),
...
app.conf.task_routes = {
	...
	"pong.tournament_round_finished": {"queue": "notifications.pong.tournament_round_finished"},
	"pong.tournament_finished": {"queue": "notifications.pong.tournament_finished"},
