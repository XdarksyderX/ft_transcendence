...
celery -A config worker --loglevel=info --queues=pong.user_registered,pong.user_deleted,pong.username_changed,pong.friend_added,pong.friend_removed,events.user_disconnected &
